...
#     CLAUDE_GLM_TEST_ERROR=1 bash <(curl -fsSL https://raw.githubusercontent.com/Blurjp/claude-glm-wrapper/main/install.sh)
#     OR: ./install.sh --test-error
#
#   Enable debug mode:
#     CLAUDE_GLM_DEBUG=1 bash <(curl -fsSL https://raw.githubusercontent.com/Blurjp/claude-glm-wrapper/main/install.sh)
#     OR: ./install.sh --debug
...
report_error() {
    ...
    if [ "$report_choice" != "y" ] && [ "$report_choice" != "Y" ]; then
        ...
        echo "  https://github.com/Blurjp/claude-glm-wrapper/issues"
        echo ""
...
"
    ...
    local issue_url="https://github.com/Blurjp/claude-glm-wrapper/issues/new?title=${encoded_title}&body=${encoded_body}&labels=bug,unix,installation"
...
if [ "$TEST_ERROR" = true ]; then
    ...
    echo "   curl -fsSL https://raw.githubusercontent.com/Blurjp/claude-glm-wrapper/main/install.sh | bash"
    echo ""
    echo "Press Enter to finish (window will remain open)..."
    read
